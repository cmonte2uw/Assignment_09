...
# CMontejo, 2022-Sept-04, Updated for inventory functions to accept list of file names, added functionality for saving tracks
#------------------------------------------#
...
class FileIO:
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            ...
            print('There was a general error!', e.__doc__, sep='\n')
