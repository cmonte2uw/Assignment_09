...
# Cmontejo, 2022-Sept-04, Added processing for selecting a CD/Album and for adding a track with error handling
#------------------------------------------#
...
class DataProcessor:
    ...
    def add_track(track_info: tuple, cd: DC.CD) -> None:
        ...
        Raises:
            Exception: Raise in case position is not an integer.
